...
/***/ function(module, exports, __webpack_require__) {
	...
	var mobileMenu = new _MobileMenu2.default(); //the mobileMenu object is a new instance of the MobileMenu class
			...
			value: function createWaypoints() {
				...
				this.itemsToReveal.each(function () {
					...
					new Waypoint({
						...
						offset: that.offsetPercentage //because 0 is the default, and that is the top edge of the browser
					});
				});
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StickyHeader = function () {
		function StickyHeader() {
			...
			this.createHeaderWaypoint(); //we write this here to be sure that the action will start as soon as the page loads
			this.pageSections = (0, _jquery2.default)('.page-section');
			this.headerLinks = (0, _jquery2.default)('.primary-nav a');
			this.createPageSectionWaypoints(); //we write this here to be sure that the action will start as soon as the page loads
			this.addSmoothScrolling(); //we write this here to be sure that the action will start as soon as the page loads
		}
